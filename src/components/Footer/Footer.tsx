...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaYoutube, FaChevronUp, FaChevronDown } from "react-icons/fa";
  ...
  const sections: Section[] = [
    {
      ...
      links: [
        ...
        { name: "Build a Test ride", path: "/festiveOffer" },
        { name: "Book Experience", path: "/festiveOffer" },
      ],
    },
    {
      title: "PRODUCTS",
      links: [
        { name: "ASHVA BSX", path: "/adventure" },
        { name: "ASHVA 4X4", path: "/proDriver" },
        { name: "ASHVA 4S", path: "/obstacle" },
        { name: "ASHVA 6X6", path: "/throttle" },
      ],
    },
    {
      title: "ABOUT Us",
