...
// const images = [
//   { src: "/assets/agri/pict1.webp" },
//   { src: "/assets/agri/pict2.webp" },
//   { src: "/assets/agri/pict3.webp" },
//   { src: "/assets/agri/pict4.webp" },
//   { src: "/assets/agri/pict5.webp" },
// ];
...
//           <p className={styles.heroSub}>India’s <br /> 1st 6x6 FUV</p>
//         </div>
...
//           <img src="/assets/agri/a-thon.webp" className={styles.partnerLogo} alt="A-THON" />
//           <span style={{fontSize:18, color:"#666"}}>x</span>
//           <img src="/assets/agri/ARTPARK.webp" className={styles.partnerLogo} alt="ARTPARK" />
//         </div>

//         <p className={styles.blurb}>
//           A market dominating technology for next 5 years.
//           <br />
//           Assisted autonomous ADBHUT Bot being integrated with ARTPARK, IISc Bengaluru.
//         </p>
...
//           Our roadmap to redefine mobility through technology leadership, off-road
//           innovation, and sustainability.
//         </p>

//         <div className={styles.timeline} aria-hidden>
//             <img src="/assets/agri/Container.png" alt="" />
//         </div>
...
//               Introduction of our flagship Ashva series with revolutionary off-road
//               capabilities and advanced materials.
//             </p>
...
//         <h4 className={styles.galleryTitle}>ULTIMATE SOLUTION FOR EVERYTHING FARMING</h4>
...
//             >
//               <img src={src} alt={`gallery ${i}`} className={styles.galleryImg} />
//               <div className={styles.galleryCaption}>
//                 {i === 0 ? "Stabilizer Hydro Drive wheels For hostile terrain" :
//                   i === 1 ? "Monitoring crop health with drone" :
//                   i === 2 ? "Pesticide application through aerial spraying" :
//                   i === 3 ? "Crop harvesting through snippers & telescopic boom" :
//                   i === 4 ? "On-site crop processing" :
