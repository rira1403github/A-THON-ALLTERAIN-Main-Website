...
// import Highlights from "@/components/HighProduct/High4S";
...
// const faqs = [
//   { id: 1, question: "What is the Ashva 4S designed for?", answer: "The Ashva 4S ATV is a compact and versatile off-road vehicle, ideal for small farms, estates, resorts, and recreational use, combining utility and adventure in one machine." },
//   { id: 2, question: "Is it easy to handle?", answer: "Yes, its lightweight and compact design makes the Ashva 4S extremely easy to maneuver, even on narrow paths or tight spaces, perfect for off-road ATV riding in India." },
//   { id: 3, question: "Can it be used for both work and fun?", answer: "Absolutely. The Ashva 4S is designed to handle everyday work efficiently while also delivering a fun and exciting off-road riding experience." },
//   { id: 4, question: "How reliable is it in Indian terrains?", answer: "Built specifically for Indian conditions, it reliably tackles rough paths, mud, small hills, and uneven surfaces." },
//   { id: 5, question: "What about maintenance and servicing?", answer: "Being proudly Made in India, the Ashva 4S offers easy access to service centers and spare parts, ensuring simple and cost-effective upkeep." },
//   { id: 6, question: "Who can benefit from using the Ashva 4S?", answer: "Farmers, estate and resort managers, adventure enthusiasts, and anyone needing a compact all-terrain vehicle will find the Ashva 4S highly useful." },
//   { id: 7, question: "Can it carry loads or tow equipment?", answer: "Yes, it can carry moderate loads and tow light equipment, making it suitable for small-scale work tasks and recreational activities." },
//   { id: 8, question: "Is it fuel-efficient?", answer: "The Ashva 4S balances power with fuel efficiency, providing cost-effective operation without compromising performance." },
//   { id: 9, question: "Can it replace multiple vehicles?", answer: "Its versatility allows it to perform multiple roles, from daily work to leisure, reducing the need for separate machines." },
//   { id: 10, question: "Why choose the Ashva 4S over imported ATVs?", answer: "Affordable, built for Indian terrains, easy to maintain, and supported by local service centers, it outperforms imported ATVs in value and practicality." },
//   { id: 11, question: "Is it safe for off-road rides?", answer: "Yes, with a sturdy build and stable design, the Ashva 4S ensures a safe and controlled ride on off-road paths." },
//   { id: 12, question: "Can it be customized for specific needs?", answer: "Yes, additional accessories or attachments can be added to suit your work or recreational requirements, enhancing its versatility as a utility ATV." }
// ];
...
//       >
//         <Image
//           src="/assets/productpage/Ashva4STitle.png"
//           alt="Ashva 4x4"
//           width={400}
//           height={100}
//           priority
...
const ProductPage: React.FC = () => {
 ...
 const images: GalleryImage[] = [
    { src: "/assets/productpage/G4s-1.webp", alt: "Ashva 4s pict 1" },
    { src: "/assets/productpage/G4s-2.webp", alt: "Ashva 4s pict 2" },
    { src: "/assets/productpage/G4s-3.webp", alt: "Ashva 4s pict 3" },
    { src: "/assets/productpage/G4s-4.webp", alt: "Ashva 4s pict 4" },
    { src: "/assets/productpage/G4s-5.webp", alt: "Ashva 4s pict 5" },
  ];
